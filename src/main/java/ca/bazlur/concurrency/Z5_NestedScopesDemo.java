 ...
 */
public final class Z5_NestedScopesDemo {
        ...
        try (var parent = StructuredTaskScope.open()) {
            parent.fork(() -> {
                ...
                try (var child = StructuredTaskScope.open(
                    ...
                    child.fork(Z5_NestedScopesDemo::taskA);
                    child.fork(Z5_NestedScopesDemo::taskB);
        ...
        try (var parent = StructuredTaskScope.open()) {
            ...
            StructuredTaskScope.Subtask<List<String>> combined = parent.fork(() -> {
                try (var child = StructuredTaskScope.open(
                    ...
                    StructuredTaskScope.Subtask<String> a = child.fork(Z5_NestedScopesDemo::taskA);
                    StructuredTaskScope.Subtask<String> b = child.fork(Z5_NestedScopesDemo::taskB);
