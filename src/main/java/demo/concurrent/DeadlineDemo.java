...
public class DeadlineDemo {
    ...
    // Deadline for all operations (in milliseconds)
    ...
    private static List<String> runWithDeadline() throws Exception {
        ...
        Instant deadline = Instant.now().plusMillis(DEADLINE_MS);
        ...
        try (var scope = new StructuredTaskScope<String>()) {
            ...
            try {
                ...
                System.out.println("All operations completed before deadline!");
            } catch (TimeoutException e) {
                System.out.println("Deadline reached! Cancelling remaining operations...");
                scope.shutdown();
            }
